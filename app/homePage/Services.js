...
export default function Services() {
  ...
  return (
    <section className="pt-20 px-5 md:px-10 lg:px-12.5 lg:flex lg:justify-between lg:gap-x-[40px] lg:flex-col xl:pt-37.5 2xl:flex-row">
      ...
      <div className="border-t border-[rgba(0,0,0,0.25)] lg:w-[100%] xl:w-[1000px] 2xl:mt-[24px]">
        <div className="flex pt-5 flex-col gap-5 pb-7 border-b border-[rgba(0,0,0,0.25)] lg:flex-row lg:gap-x-[30px] lg:justify-between  2xl:pt-12">
          <div className="flex">
