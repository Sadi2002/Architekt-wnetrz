...
export default function Foto() {
  ...
  const yRight = useTransform(scrollYProgress, [0, 1], [0, -1200]);
  ...
  const imgYLeft = useTransform(scrollYProgress, [0, 1], [0, -10]);
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex flex-col gap-5 lg:justify-center lg:w-[25%] lg:gap-10"
      >
        ...
        <div className="flex flex-col gap-5">
          <p className="foto-text text-[clamp(14px,4vw,16px)] leading-[clamp(22px,4vw,24px)] text-white font-cormorant px-5 lg:max-w-[500px] lg:px-0 lg:text-[20px]">
      ...
      <div className="flex justify-end pr-5 lg:w-[40%] lg:justify-start lg:relative lg:top-[300px]">
        <motion.div
